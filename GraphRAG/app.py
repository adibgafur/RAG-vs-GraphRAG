...
def make_llm_fn(provider: str, api_key: str, model_name: str = None):
    """Return a simple llm_fn(prompt) -> str for use during ingestion (summaries)."""
    def llm_fn(prompt: str) -> str:
        if provider == "groq":
            from groq import Groq, BadRequestError, PermissionDeniedError
...
def call_llm(messages: list, context: str, mode: str, provider: str, api_key: str, model_name: str = None) -> str:
